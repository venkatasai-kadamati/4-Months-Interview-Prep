...
//        ** The idea is to move linearly by substracting the uncommon element of the three. While iteration 1, 5, -1 & Further 5, -1, 6 we find that 5, -1 is common and we simply add 6 and remove 1.
        int n = arr.length;
